// Rota catch-all: o Efí sempre chama a URL registrada com "/pix" no final
// (ex: registramos .../webhooks/efi, ele chama .../webhooks/efi/pix), então
// aceitamos qualquer sufixo aqui em vez de depender de acertar o caminho exato.
